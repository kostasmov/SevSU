...
class Stack:
    """Стек: Контейнер по принципу LIFO (последним вошёл - первым вышел)"""
    def __init__(self):
        self.list = []
...
class Queue:
    """Очередь: Контейнер по принципу FIFO (первым вошёл - первым вышел)"""
    def __init__(self):
        self.list = []

    def push(self,item):
        """Добавить элемент в очередь (в начало)"""
        self.list.insert(0,item)

    def pop(self):
        """Удалить и вернуть элемент из конца очереди"""
        return self.list.pop()
...
class PriorityQueue:
    """
      ...
      Извлекается элемент с наименьшим приоритетом (чем меньше число, тем выше приоритет).
    ...
    def update(self, item, priority):
        """
          ...
          - Если элемент уже есть и его приоритет выше нового — обновить и перестроить кучу.
          - Если элемент уже есть и его приоритет ниже или равен новому — ничего не делать.
          - Если элемента нет — добавить его как новый (self.push).
        """
