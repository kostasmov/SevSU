...
a1 = ann_tansig_activ(n1);              // активность на выходе 1-го слоя
d_a1 = ann_d_tansig_activ(a1);          // производная активационной функции 
...
a2 = ann_tansig_activ(n2);              // активность на выходе 2-го слоя
d_a2 = ann_d_tansig_activ(a2);          // производная активационной функции 
...
subplot(2, 2, 4)
histplot(20, d_a1);
title('Гистограмма производных функции tansig')
