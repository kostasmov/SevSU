...
class TaskParameters:
    ...
    def __init__(self):
        ...
        # Параметры технического обслуживания: для каждого прибора задан
        # ОДИН заранее фиксированный промежуток ТО [TM[l], TM[l]+tm_maint[l]],
        # а не периодически повторяющийся цикл. Пакеты планируются либо
        # целиком до начала этого промежутка, либо целиком после него.
        self.TM = [20.0, 25.0, 18.0]        # момент начала ТО прибора l
        self.tm_maint = [2.0, 3.0, 2.0]     # длительность ТО прибора l
